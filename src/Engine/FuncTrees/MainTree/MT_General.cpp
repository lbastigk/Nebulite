...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::setGlobal(int argc, char* argv[]){
    if(argc == 3){
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::eval(int argc, char* argv[]){
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::exitProgram(int argc, char* argv[]){
    global->getRenderer()->setQuit();
    return Nebulite::ERROR_TYPE::NONE;
}

Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::stateLoad(int argc, char* argv[]){ 
    std::cerr << "Function load not implemented yet!" << std::endl;
    return Nebulite::ERROR_TYPE::CRITICAL_FUNCTION_NOT_IMPLEMENTED;
}

Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::stateSave(int argc, char* argv[]){
    // <stateName>
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::wait(int argc, char* argv[]){
    if(argc == 2){
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::loadTaskList(int argc, char* argv[]) {
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::echo(int argc, char* argv[]) {
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::forLoop(int argc, char* argv[]){
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::error(int argc, char* argv[]) {
    for (int i = 1; i < argc; ++i) {
        std::cerr << argv[i];
        if (i < argc - 1) {
            std::cerr << " ";
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::func_assert(int argc, char* argv[]){
    return Nebulite::ERROR_TYPE::CRITICAL_CUSTOM_ASSERT;
}

Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::func_return(int argc, char* argv[]){
    if (argc < 2) {
        return Nebulite::ERROR_TYPE::TOO_FEW_ARGS;
    }
    if (argc > 2) {
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::forceGlobal(int argc, char* argv[]) {
    if (argc < 3) {
        return Nebulite::ERROR_TYPE::TOO_FEW_ARGS;
    }
    if (argc > 3) {
...
Nebulite::ERROR_TYPE Nebulite::MainTreeCategory::General::clearForceGlobal(int argc, char* argv[]) {
