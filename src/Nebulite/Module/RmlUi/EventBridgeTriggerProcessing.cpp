...
void EventBridge::Attribute::OnDestroy::processTrigger(Graphics::RmlUi::Interface& manager, Utility::Io::Capture& capture, Rml::Element* element){
    if (!element) return;
...
void EventBridge::Attribute::OnEnter::processTrigger(Graphics::RmlUi::Interface& manager, Utility::Io::Capture& capture, SDL_Event const& event, int /*keyModifiers*/, Rml::Element* focusElement){
...
void EventBridge::Attribute::OnClick::processTrigger(Graphics::RmlUi::Interface& manager, Utility::Io::Capture& capture, SDL_Event const& event, int /*keyModifiers*/, Rml::Element* focusElement){
    if (!focusElement) return;
