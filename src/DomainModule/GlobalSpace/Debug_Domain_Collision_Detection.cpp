...
//------------------------------------------
// Category names
std::string const Debug_Domain_Collision_Detection::debug_name = "debug";
std::string const Debug_Domain_Collision_Detection::debug_desc = "DomainModule for special debugging capabilities within the GlobalSpace.";

std::string const Debug_Domain_Collision_Detection::collisionDetect_name = "debug collision-detect";
std::string const Debug_Domain_Collision_Detection::collisionDetect_desc = "Utilities for testing collision detection functionalities.";
