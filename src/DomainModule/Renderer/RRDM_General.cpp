...
Nebulite::Constants::Error General::env_load([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if(argc > 1){
...
Nebulite::Constants::Error General::env_deload([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    domain->purgeObjects();
...
Nebulite::Constants::Error General::spawn([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if(argc>1){
...
Nebulite::Constants::Error General::setResolution([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    int w,h,scalar;
    w = 1000;
    h = 1000;
    scalar = 1;
...
Nebulite::Constants::Error General::setFPS([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    int fps = 60;
    if(argc == 2){
        fps = std::stoi(argv[1]);
        if(fps < 1) fps=1;
...
Nebulite::Constants::Error General::showFPS([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if(argc < 2){
...
Nebulite::Constants::Error General::cam_move([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if (argc < 3) {
        return Nebulite::Constants::ErrorTable::FUNCTIONAL::TOO_FEW_ARGS();
    }
    if (argc > 3) {
...
Nebulite::Constants::Error General::cam_set([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if(argc == 3){
...
Nebulite::Constants::Error General::snapshot([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if(argc == 1){
...
Nebulite::Constants::Error General::beep([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
...
Nebulite::Constants::Error General::selectedObject_get([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    if (argc != 2) {
        return Nebulite::Constants::ErrorTable::FUNCTIONAL::TOO_FEW_ARGS();
    }
...
Nebulite::Constants::Error General::selectedObject_Parse([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    if(argc < 2){
        return Nebulite::Constants::ErrorTable::FUNCTIONAL::TOO_FEW_ARGS();
    }
    std::string command;
