...
Nebulite::Constants::Error Logging::log_all([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
...
Nebulite::Constants::Error Logging::log_key([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    if (argc < 2) {
