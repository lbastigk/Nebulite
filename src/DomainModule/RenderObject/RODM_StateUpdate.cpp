...
Nebulite::Constants::Error StateUpdate::func_delete([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
...
Nebulite::Constants::Error StateUpdate::updateText([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
...
Nebulite::Constants::Error StateUpdate::invoke_reload([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
...
Nebulite::Constants::Error StateUpdate::invoke_add([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    return Nebulite::Constants::ErrorTable::FUNCTIONAL::CRITICAL_FUNCTION_NOT_IMPLEMENTED();
}
...
Nebulite::Constants::Error StateUpdate::invoke_remove([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    return Nebulite::Constants::ErrorTable::FUNCTIONAL::CRITICAL_FUNCTION_NOT_IMPLEMENTED();
}
...
Nebulite::Constants::Error StateUpdate::invoke_purge([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    return Nebulite::Constants::ErrorTable::FUNCTIONAL::CRITICAL_FUNCTION_NOT_IMPLEMENTED();
}
