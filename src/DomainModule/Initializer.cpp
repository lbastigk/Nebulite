...
void Initializer::initGlobalSpace(Nebulite::Core::GlobalSpace* target) {
    //------------------------------------------
...
void Initializer::initJSON(Nebulite::Utility::JSON* target) {
    // Initialize DomainModules
...
void Initializer::initRenderObject(Nebulite::Core::RenderObject* target) {
    // Initialize DomainModules
...
void Initializer::initRenderer(Nebulite::Core::Renderer* target) {
    // Initialize DomainModules
...
void Initializer::initTexture(Nebulite::Core::Texture* target) {
    // Initialize DomainModules
