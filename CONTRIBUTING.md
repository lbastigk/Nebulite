...
3. **Implement command methods:** Functions with `Nebulite::Constants::Error ([[maybe_unused]] int argc, [[maybe_unused]] char* argv[])` signature
...
public:
    ...
    Nebulite::Constants::Error spawnCircle([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
...
Nebulite::Nebulite::Constants::Error Nebulite::DomainModule::GlobalSpace::MyModule::spawnCircle([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]){
    /*
    Implementation here.
