...
template <typename T>
T JSONHandler::Get::Any(rapidjson::Document& doc, const std::string& fullKey, const T& defaultValue = T()) {
...
template <typename T>
void JSONHandler::Set::Any(rapidjson::Document& doc, const std::string& fullKey, const T data, bool onlyIfExists = false) {
