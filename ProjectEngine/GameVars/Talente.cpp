...
public:
    ...
    Talente() {
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.koerper._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.natur._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.wissen._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.gesellschaft._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.handwerk._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.nahkampf._self, &temp);    //add to main doc
        temp.RemoveAllMembers();
        ...
        JSONHandler::Set::Any(doc, namenKonvention.talente.fernkampf._self, &temp);    //add to main doc
    ...
    Talente& operator=(const Talente& other) {  // Assignment operator overload
        if (this != &other) {
