...
public:
     ...
     */
    virtual void broadcast(std::shared_ptr<Interaction::Rules::Ruleset> const& entry) const {
        (void)entry;
    }
     ...
     */
    virtual void listen(Interaction::Execution::Domain& listener, std::string const& topic, uint32_t const& listenerId) const {
        (void)listener;
        (void)topic;
        (void)listenerId;
    }
