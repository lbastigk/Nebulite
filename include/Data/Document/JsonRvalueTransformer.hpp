...
private:
    ...
    bool assertNonEmpty(JSON* jsonDoc);
    ...
    bool toBoolString(JSON* jsonDoc);
    ...
    bool typeAsNumber(JSON* jsonDoc);
    ...
    bool typeAsString(JSON* jsonDoc);
