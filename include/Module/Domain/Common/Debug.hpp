...
public:
    ...
    [[nodiscard]] static Constants::Event fetchId(std::span<std::string_view const> const& args, Interaction::Context const& ctx, Interaction::ContextScope const& ctxScope);
    ...
    [[nodiscard]] static Constants::Event fetchName(std::span<std::string_view const> const& args, Interaction::Context const& ctx, Interaction::ContextScope const& ctxScope);
    ...
    [[nodiscard]] static Constants::Event print(std::span<std::string_view const> const& args, Interaction::Context const& ctx, Interaction::ContextScope const& ctxScope);
    ...
    [[nodiscard]] static Constants::Event printId(std::span<std::string_view const> const& args, Interaction::Context const& ctx, Interaction::ContextScope& ctxScope);
    ...
    [[nodiscard]] Constants::Event warn(std::span<std::string_view const> const& args) const ;
    ...
    [[nodiscard]] static Constants::Event error(std::span<std::string_view const> const& args, Interaction::Context const& ctx, Interaction::ContextScope& ctxScope);
    ...
    [[noreturn]] static Constants::Event func_throw(std::span<std::string_view const> const& args);
    ...
    [[nodiscard]] static Constants::Event mustThrow(std::span<std::string_view const> const& args, Interaction::Context& ctx, Interaction::ContextScope& ctxScope);
