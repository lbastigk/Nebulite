...
public:
    ...
    [[nodiscard]] static Constants::Event jsonSet(std::span<std::string const> const& args, Interaction::Execution::Domain& caller, Data::JsonScope& callerScope);
    ...
    [[nodiscard]] static Constants::Event evaluateRecursive(std::span<std::string const> const& args, Interaction::Execution::Domain& caller, Data::JsonScope& callerScope);
