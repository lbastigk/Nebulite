...
#ifndef MODULE_DOMAIN_COMMON_FILESYSTEM_HPP
#define MODULE_DOMAIN_COMMON_FILESYSTEM_HPP
...
class Filesystem final : public Interaction::Execution::DomainModule<Interaction::Execution::Domain> {
public:
...
#endif // MODULE_DOMAIN_COMMON_FILESYSTEM_HPP
