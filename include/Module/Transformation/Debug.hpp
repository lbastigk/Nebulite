...
public:
    ...
    static bool warn(std::span<std::string const> const& args);
    ...
    static bool error(std::span<std::string const> const& args);
    ...
    static bool store(std::span<std::string const> const& args, Data::JsonScope const* jsonDoc);
