...
public:
    ...
    static bool assertNonEmpty(std::span<std::string const> const& args, Data::JsonScope* jsonDoc);
    ...
    static bool assertTypeObject(std::span<std::string const> const& args, Data::JsonScope* jsonDoc);
    ...
    static bool assertTypeArray(std::span<std::string const> const& args, Data::JsonScope* jsonDoc);
    ...
    static bool assertTypeBasicValue(std::span<std::string const> const& args, Data::JsonScope* jsonDoc);
