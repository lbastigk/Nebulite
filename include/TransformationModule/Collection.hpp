...
public:
    explicit Collection(std::shared_ptr<Interaction::Execution::FuncTree<bool, Data::JsonScopeBase*>> const& funcTree)
    ...
    bool map(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc) const ; // Map needs to reparse, so it's a member function
    ...
    static bool get(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool getMultiple(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool filterRegex(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool filterGlob(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool filterNulls(Data::JsonScopeBase* jsonDoc);
    ...
    static bool listMembers(Data::JsonScopeBase* jsonDoc);
