...
public:
    explicit Arithmetic(std::shared_ptr<Interaction::Execution::FuncTree<bool, Data::JsonScopeBase*>> const& funcTree)
    ...
    static bool add(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool mod(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool multiply(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool pow(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool subtract(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool divide(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool root(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool sqrt(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
