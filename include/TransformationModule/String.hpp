...
public:
    explicit String(std::shared_ptr<Interaction::Execution::FuncTree<bool, Data::JsonScopeBase*>> const& funcTree)
    ...
    static bool toUpper(Data::JsonScopeBase* jsonDoc);
    ...
    static bool toLower(Data::JsonScopeBase* jsonDoc);
    ...
    static bool strip(Data::JsonScopeBase* jsonDoc);
    ...
    static bool lStrip(Data::JsonScopeBase* jsonDoc);
    ...
    static bool rStrip(Data::JsonScopeBase* jsonDoc);
    ...
    static bool substring(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool replace(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool strCountAppearance(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool strcompareEquals(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool strcompareContains(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool strcompareStartsWith(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool strcompareEndsWith(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
