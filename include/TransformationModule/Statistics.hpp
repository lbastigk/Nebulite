...
public:
    ...
    static bool sum(Core::JsonScope* scope);
    ...
    static bool average(Core::JsonScope* scope);
    ...
    static bool product(Core::JsonScope* scope);
    ...
    static bool min(Core::JsonScope* scope);
    ...
    static bool max(Core::JsonScope* scope);
    ...
    static bool median(Core::JsonScope* scope);
    ...
    static bool stddev(Core::JsonScope* scope);
...
private:
     ...
     */
    static double accumulate(Core::JsonScope const* scope, std::function<double(double, double)> const& func, double const& initialValue = 0.0);
};
} // namespace Nebulite::TransformationModule
