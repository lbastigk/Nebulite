...
public:
    explicit Statistics(std::shared_ptr<Interaction::Execution::FuncTree<bool, Data::JsonScopeBase*>> const& funcTree)
    ...
    static bool sum(Data::JsonScopeBase* scope);
    ...
    static bool average(Data::JsonScopeBase* scope);
    ...
    static bool product(Data::JsonScopeBase* scope);
    ...
    static bool min(Data::JsonScopeBase* scope);
    ...
    static bool max(Data::JsonScopeBase* scope);
    ...
    static bool median(Data::JsonScopeBase* scope);
    ...
    static bool stddev(Data::JsonScopeBase* scope);
...
private:
     ...
     */
    static double accumulate(Data::JsonScopeBase const* scope, std::function<double(double, double)> const& func, double const& initialValue = 0.0);
};
} // namespace Nebulite::TransformationModule
