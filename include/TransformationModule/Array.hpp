...
public:
    explicit Array(std::shared_ptr<Interaction::Execution::FuncTree<bool, Data::JsonScopeBase*>> const& funcTree)
    ...
    static bool ensureArray(Data::JsonScopeBase* jsonDoc);
    ...
    static bool at(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool length(Data::JsonScopeBase* jsonDoc);
    ...
    static bool reverse(Data::JsonScopeBase* jsonDoc);
    ...
    static bool first(Data::JsonScopeBase* jsonDoc);
    ...
    static bool last(Data::JsonScopeBase* jsonDoc);
    ...
    static bool push(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool pushNumber(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
    ...
    static bool subspan(std::span<std::string const> const& args, Data::JsonScopeBase* jsonDoc);
