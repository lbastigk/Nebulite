...
public:
    ...
    JsonScope(Data::JSON& doc, std::string const& prefix, std::string const& name = "Unnamed JsonScope");
    ...
    [[nodiscard]] JsonScope& shareScope(Data::ScopedKey const& key) const { return shareScope(key.view()); }
