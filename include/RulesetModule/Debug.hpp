...
public:
    ...
    void message(Interaction::Context const& context, double**& slf) const ;
    ...
    void error(Interaction::Context const& context, double**& slf) const ;
    ...
    void whoInteracts(Interaction::Context const& context, double**& slf) const ;
