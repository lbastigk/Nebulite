...
public:
    ...
    void elasticCollision(Interaction::Context const& context, double**& slf) const ;
    ...
    void gravity(Interaction::Context const& context, double**& slf) const ;
    ...
    void applyForce(Interaction::Context const& context, double**& slf) const ;
    ...
    void drag(Interaction::Context const& context, double**& slf) const ;
