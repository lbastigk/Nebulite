...
public:
    ...
    void alignCenter(Interaction::Context const& context) const ;
    ...
    void alignTop(Interaction::Context const& context) const ;
    ...
    void alignBottom(Interaction::Context const& context) const ;
    ...
    void alignLeft(Interaction::Context const& context) const ;
    ...
    void alignRight(Interaction::Context const& context) const ;
