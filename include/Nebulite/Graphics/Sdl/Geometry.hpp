#ifndef NEBULITE_GRAPHICS_SDL_GEOMETRY_HPP
#define NEBULITE_GRAPHICS_SDL_GEOMETRY_HPP
 ...
 */
void drawFilledCircle(SDL_Renderer* renderer, SDL_Texture* texture, SDL_Color const& color, int radius);
...
#endif // NEBULITE_GRAPHICS_SDL_GEOMETRY_HPP
