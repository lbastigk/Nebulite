#ifndef NEBULITE_MODULE_TRANSFORMATION_FILTER_HPP
#define NEBULITE_MODULE_TRANSFORMATION_FILTER_HPP
...
public:
    ...
    static bool filterRegex(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool filterGlob(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool filterRegexValue(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool filterGlobValue(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool filterCustom(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
...
#endif // NEBULITE_MODULE_TRANSFORMATION_FILTER_HPP
