#ifndef NEBULITE_MODULE_TRANSFORMATION_ASSERTIONS_HPP
#define NEBULITE_MODULE_TRANSFORMATION_ASSERTIONS_HPP
...
public:
    ...
    static auto constexpr assertMatchDesc = "Assertion transformations that validate JSON string values with patterns and throw exceptions on failure.";
