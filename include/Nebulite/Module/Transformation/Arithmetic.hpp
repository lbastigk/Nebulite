...
public:
    ...
    static bool add(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool mod(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool multiply(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool pow(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool subtract(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool divide(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool root(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool sqrt(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
...
private:
    template<typename F>
    static bool forall(std::span<std::string_view const> args, F&& f) {
