#ifndef NEBULITE_MODULE_TRANSFORMATION_STRING_HPP
#define NEBULITE_MODULE_TRANSFORMATION_STRING_HPP
...
public:
    explicit String(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
    ...
    static bool lPad(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool rPad(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool lPadNumeric(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool rPadNumeric(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool lPadNonNumeric(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool rPadNonNumeric(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool substring(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool replace(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strCountAppearance(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool split(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strcompareMembers(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strcompareEquals(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strcompareContains(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strcompareStartsWith(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool strcompareEndsWith(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
...
#endif // NEBULITE_MODULE_TRANSFORMATION_STRING_HPP
