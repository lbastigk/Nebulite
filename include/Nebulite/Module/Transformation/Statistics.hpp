#ifndef NEBULITE_MODULE_TRANSFORMATION_STATISTICS_HPP
#define NEBULITE_MODULE_TRANSFORMATION_STATISTICS_HPP
...
public:
    explicit Statistics(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
    ...
    static bool sum(Data::JsonScope& jsonDoc);
    ...
    static bool average(Data::JsonScope& jsonDoc);
    ...
    static bool product(Data::JsonScope& jsonDoc);
    ...
    static bool min(Data::JsonScope& jsonDoc);
    ...
    static bool max(Data::JsonScope& jsonDoc);
    ...
    static bool median(Data::JsonScope& jsonDoc);
    ...
    static bool stddev(Data::JsonScope& jsonDoc);
...
private:
     ...
     * @param jsonDoc The JSON scope containing the array to accumulate over.
     ...
     */
    static double accumulate(Data::JsonScope const& jsonDoc, std::function<double(double, double)> const& func, double initialValue = 0.0);
};
} // namespace Nebulite::Module::Transformation
#endif // NEBULITE_MODULE_TRANSFORMATION_STATISTICS_HPP
