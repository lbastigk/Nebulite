#ifndef NEBULITE_MODULE_TRANSFORMATION_DOMAIN_HPP
#define NEBULITE_MODULE_TRANSFORMATION_DOMAIN_HPP
...
public:
    explicit Domain(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
...
#endif // NEBULITE_MODULE_TRANSFORMATION_DOMAIN_HPP
