#ifndef NEBULITE_MODULE_TRANSFORMATION_DEBUG_HPP
#define NEBULITE_MODULE_TRANSFORMATION_DEBUG_HPP
...
public:
    explicit Debug(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
    ...
    static bool echo(std::span<std::string_view const> args);
    ...
    static bool warn(std::span<std::string_view const> args);
    ...
    static bool error(std::span<std::string_view const> args);
    ...
    static bool print(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    [[noreturn]] static bool unreachable(std::span<std::string_view const> args);
    ...
    static bool store(std::span<std::string_view const> args, Data::JsonScope const& jsonDoc);
...
#endif // NEBULITE_MODULE_TRANSFORMATION_DEBUG_HPP
