...
public:
    explicit General(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
    ...
    static bool setString(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool setInt(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool setDouble(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool setBool(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool removeMember(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
    ...
    static bool assign(std::span<std::string_view const> args, Data::JsonScope& jsonDoc);
