#ifndef NEBULITE_MODULE_TRANSFORMATION_CASTING_HPP
#define NEBULITE_MODULE_TRANSFORMATION_CASTING_HPP
...
public:
    explicit Casting(std::shared_ptr<Utility::Args::FuncTree<bool, Data::JsonScope&>> const& funcTree)
...
#endif // NEBULITE_MODULE_TRANSFORMATION_CASTING_HPP
