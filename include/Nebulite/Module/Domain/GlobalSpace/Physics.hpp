#ifndef NEBULITE_MODULE_DOMAIN_GLOBALSPACE_PHYSICS_HPP
#define NEBULITE_MODULE_DOMAIN_GLOBALSPACE_PHYSICS_HPP
...
#endif // NEBULITE_MODULE_DOMAIN_GLOBALSPACE_PHYSICS_HPP
