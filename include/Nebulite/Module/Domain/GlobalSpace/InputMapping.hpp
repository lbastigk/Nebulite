#ifndef NEBULITE_MODULE_DOMAIN_GLOBALSPACE_INPUTMAPPING_HPP
#define NEBULITE_MODULE_DOMAIN_GLOBALSPACE_INPUTMAPPING_HPP
...
public:
    ...
    [[nodiscard]] Constants::Event lockOnce(std::span<std::string_view const> args);
    ...
    [[nodiscard]] Constants::Event lockOn(std::span<std::string_view const> args);
    ...
    [[nodiscard]] Constants::Event unlock(std::span<std::string_view const> args);
...
#endif // NEBULITE_MODULE_DOMAIN_GLOBALSPACE_INPUTMAPPING_HPP
