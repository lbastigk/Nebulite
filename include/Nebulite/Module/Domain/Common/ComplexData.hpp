#ifndef NEBULITE_MODULE_DOMAIN_COMMON_COMPLEXDATA_HPP
#define NEBULITE_MODULE_DOMAIN_COMMON_COMPLEXDATA_HPP
...
public:
    ...
    [[nodiscard]] static Constants::Event jsonSet(std::span<std::string_view const> args, Interaction::Context const& ctx, Interaction::ContextScope const& ctxScope);
    ...
    [[nodiscard]] static Constants::Event evaluateMember(std::span<std::string_view const> args, Interaction::Context const& ctx, Interaction::ContextScope const& ctxScope);
    ...
    [[nodiscard]] static Constants::Event evaluateRecursive(std::span<std::string_view const> args, Interaction::Context const& ctx, Interaction::ContextScope& ctxScope);
...
#endif // NEBULITE_MODULE_DOMAIN_COMMON_COMPLEXDATA_HPP
