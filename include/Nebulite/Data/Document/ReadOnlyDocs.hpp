#ifndef NEBULITE_DATA_DOCUMENT_READONLYDOCS_HPP
#define NEBULITE_DATA_DOCUMENT_READONLYDOCS_HPP
...
private:
     ...
     */
    static constexpr std::uint64_t unloadTime = 5U * Utility::Time::Conversion::millisecondsPerMinute;
...
#endif // NEBULITE_DATA_DOCUMENT_READONLYDOCS_HPP
