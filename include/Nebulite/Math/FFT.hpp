 ...
 * @brief Functions for performing Fast Fourier Transform (FFT) and related operations on audio data.
 */
namespace Nebulite::Math::Fft {
/**
 ...
 */
std::complex<double> evalTransfer(double omega,std::vector<double> const& num,std::vector<double> const& den);
