...
public:
     ...
     */
    Nebulite::Constants::Error mirror_once([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error mirror_on([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error mirror_off([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error mirror_delete([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error mirror_fetch([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
