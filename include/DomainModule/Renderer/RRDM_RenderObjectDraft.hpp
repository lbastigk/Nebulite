...
public:
     ...
     */
    Nebulite::Constants::Error draft_parse([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error draft_spawn([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occured on command execution
     */
    Nebulite::Constants::Error draft_reset([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
