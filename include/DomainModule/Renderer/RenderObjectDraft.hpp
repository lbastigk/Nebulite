...
#ifndef NEBULITE_DOMAINMODULE_RENDERER_RENDER_OBJECT_DRAFT_HPP
#define NEBULITE_DOMAINMODULE_RENDERER_RENDER_OBJECT_DRAFT_HPP
...
public:
    ...
    [[nodiscard]] Constants::Event draft_parse(std::span<std::string const> const& args);
