...
public:
     ...
     */
    Nebulite::Constants::Error query_set([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
     ...
     * @return Potential errors that occurred on command execution.
     */
    Nebulite::Constants::Error json_set([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]);
