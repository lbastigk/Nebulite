...
#ifndef NEBULITE_DOMAINMODULE_TEXTURE_ROTATION_HPP
#define NEBULITE_DOMAINMODULE_TEXTURE_ROTATION_HPP
...
public:
    ...
    [[nodiscard]] Constants::Error rotate(int argc, char** argv) const ;
