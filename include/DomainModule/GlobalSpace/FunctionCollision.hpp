...
public:
    ...
    Constants::Error debug_collisionDetect_function(std::span<std::string const> const& args) const ;
    ...
    Constants::Error debug_collisionDetect_category(std::span<std::string const> const& args) const ;
    ...
    Constants::Error debug_collisionDetect_variable(std::span<std::string const> const& args) const ;
