...
public:
     ...
     */
    [[nodiscard]] Constants::Error errorLog(std::span<std::string const> const& args, Interaction::Execution::Domain& caller, Data::JsonScope& callerScope);
    ...
    [[nodiscard]] static Constants::Error clearConsole(std::span<std::string const> const& args);
    ...
    [[nodiscard]] Constants::Error log_global(int argc, char** argv) const ;
    ...
    [[nodiscard]] Constants::Error log_state(int argc, char** argv) const ;
    ...
    [[nodiscard]] static Constants::Error crash(std::span<std::string const> const& args, Interaction::Execution::Domain& caller, Data::JsonScope& callerScope);
    ...
    [[nodiscard]] static Constants::Error waitForInput(std::span<std::string const> const& args, Interaction::Execution::Domain& caller, Data::JsonScope& callerScope);
    ...
    [[nodiscard]] Constants::Error standardFileRenderObject(std::span<std::string const> const& args) const ;
    ...
    [[nodiscard]] static Constants::Error listExpressionFunctions(std::span<std::string const> const& args);
