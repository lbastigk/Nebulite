...
public:
    ...
    [[nodiscard]] Constants::Error time_haltOnce();
    ...
    [[nodiscard]] Constants::Error time_lock(int argc, char** argv);
    ...
    [[nodiscard]] Constants::Error time_unlock(int argc, char** argv);
    ...
    [[nodiscard]] Constants::Error time_masterUnlock();
    ...
    [[nodiscard]] Constants::Error time_setFixedDeltaTime(int argc, char** argv);
