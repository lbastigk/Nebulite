...
private:
    ...
    //
    // Static Rulesets:
    // Average total time for small benchmark: 3.270700 s
    // Average frame time for large benchmark: 0.009077 s
    // JSON Rulesets:
    // Average total time for small benchmark: 6.641500 s
    // Average frame time for large benchmark: 0.163032 s
