...
public:
     ...
     */
    std::string eval(Data::JsonScope& current_other, uint16_t const& max_recursion_depth = standardMaximumRecursionDepth);
...
private:
     ...
     */
    void updateCaches(Data::JsonScope& reference);
     ...
     */
    bool handleComponentTypeVariable(std::string& token, std::shared_ptr<Component> const& component, Data::JsonScope& current_other, uint16_t const& maximumRecursionDepth) const;
